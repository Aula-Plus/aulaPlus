 ...
 * minor's learning profile — see CLAUDE.md security rule 11. Authorship/
 * approval workflow (requires_external_approval, approved) is wired up in
 * session 3; this session only adds the table and Eloquent relations.
 */
#[Fillable([
    'student_id',
    'type',
